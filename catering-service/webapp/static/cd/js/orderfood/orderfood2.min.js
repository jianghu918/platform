...
PageFoodClick2=function(pageclickednumber){var totalpages=$("#totalpage").val();var body=(window.opera)?(document.compatMode=="CSS1Compat"?$('html'):$('body')):$('html,body');$("#pager").pager({pagenumber:pageclickednumber,pagecount:totalpages,buttonClickCallback:PageFoodClick2});$("#pageno").val(pageclickednumber);var filterobject=$("#filterobject").val();if(filterobject==''){filterobject='allrestfood';}
var restfoodtype=$("#restfoodtype").val();if(restfoodtype==''){restfoodtype='0';}
var searchword=$("#searchword").val();if(searchword==''){searchword='0';}
var hashstr=filterobject+'_'+pageclickednumber+'_'+restaurantid+'_'+restfoodtype+'_'+searchword;hashstr=hashstr.replace(/^.*#/,'');$.historyLoad(hashstr);body.animate({scrollTop:$('#right-menu').offset().top-100},50);}
...
var restaurantid=$("#restaurantid").val();var foodtype=$("#foodtype").val();var type=$("#type").val();var number=Math.random();$.ajax({type:"POST",url:_context+"/orderfood.do?method=getPageRestaurantFood2",dataType:"json",data:{searchword:searchword,foodtype:foodtype,type:type,restfoodtype:restfoodtype,filterobject:filterobject,pageno:pageno,restaurantid:restaurantid,number:number},success:function(json){var foods=json.foods;var alcoltypes=json.alcoholtypes;var totalpage=json.totalpage;var length=foods.length;var displaystyle=json.displaystyle;var html2='';if(foodtype=='2'){var alcoholtypename=$("#alcoholtypename").val();html2+='<div class="whaterBlok">'+'<div class="clearfix whaterBlokTittle">'+'<div><img width="730" height="5" src="'+_context+'/images/orderfood/round1.gif"/></div>'+'<div style="padding-left:15px !important;padding-left:0px;">'+'<table width="730" id="secondType">'+'<tbody>';for(var a=0;a<alcoltypes.length;a=a+6){html2+='<tr><td width="20%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a].id+', 0, this, \''+alcoltypes[a].name+'\')"';if(restfoodtype==alcoltypes[a].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a].name+'</a></td>';var b=a+1;var c=a+2;var d=a+3;var e=a+4;var f=a+5;if(b<alcoltypes.length){html2+='<td width="16%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a+1].id+', 0, this, \''+alcoltypes[a+1].name+'\')"';if(restfoodtype==alcoltypes[a+1].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a+1].name+'</a></td>';}
if(c<alcoltypes.length){html2+='<td width="16%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a+2].id+', 0, this, \''+alcoltypes[a+2].name+'\')"';if(restfoodtype==alcoltypes[a+2].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a+2].name+'</a></td>';}
if(d<alcoltypes.length){html2+='<td width="16%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a+3].id+', 0, this, \''+alcoltypes[a+3].name+'\')"';if(restfoodtype==alcoltypes[a+3].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a+3].name+'</a></td>';}
if(e<alcoltypes.length){html2+='<td width="16%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a+4].id+', 0, this, \''+alcoltypes[a+4].name+'\')"';if(restfoodtype==alcoltypes[a+4].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a+4].name+'</a></td>';}
if(f<alcoltypes.length){html2+='<td width="16%"><a href="javascript:clkrestfoodtype2(2, '+alcoltypes[a+5].id+', 0, this, \''+alcoltypes[a+5].name+'\')"';if(restfoodtype==alcoltypes[a+5].id){html2+='class="selected"';}
html2+='>'+alcoltypes[a+5].name+'</a></td>';}
html2+='</tr>';}
...
html2+='</ul><div style="position:relative;*top:-5px;"><img width="730" height="5" src="'+_context+'/images/orderfood/round2.gif"/></div></div>';}else{if(displaystyle=='1'){html2+='<div class="whaterBlok">'+'<div style="margin-top:15px;"><img width="730" height="5" src="'+_context+'/images/orderfood/round1.gif"/></div>'+'<ul class="whaterSheet">';for(var m=0;m<length;m++){if(m%2==0){html2+='<li class="liEven clearfix" onmouseover="javascript:mouseOverAlcohol(this);" onmouseout="javascript:mouseoutAlcohol(this);">';}else{html2+='<li class="liOdd clearfix" onmouseover="javascript:mouseOverAlcohol(this);" onmouseout="javascript:mouseoutAlcohol(this);">';}
html2+='<p class="left pTittle">'+foods[m].name+'</p><p class="left"><span>';if(foods[m].makingmethod==''||foods[m].makingmethod=='undefined'||foods[m].makingmethod==undefined){html2+='---';}else{html2+=foods[m].makingmethod;}
html2+='</span></p> <p class="left gray"> <del>￥'+foods[m].price+'</del></p><p class="left "><span class="price">￥'+foods[m].curprice+'</span>./'+foods[m].unitdesc+'</p>';if(foods[m].issupplytype=='0'){html2+='<p class="left"><a onclick="javascript:addToMyCartnoleave4(\''+foods[m].foodid+'\', \''+foods[m].foodtype+'\', \''+foods[m].curprice+'\', \'0\', \''+foods[m].name+'\', \''+restaurantid+'\', this);"><img src="'+_context+'/images/orderfood/btnAddToDiet.gif" /></a></p>';}else{html2+='<p class="left"><a href="javascript:void(0);"><img src="'+_context+'/images/orderfood/btnAddToDiet2.gif" /></a></p>';}
html2+='<div class="successaddmenu1">成功加入菜单</div></li>';}
html2+='</ul><div style="position:relative;*top:-5px;"><img width="730" height="5" src="'+_context+'/images/orderfood/round2.gif"/></div></div>';}else if(displaystyle=='2'){var pics=0;var picpaths=[];for(var p=0;p<length;p++){if(foods[p].picpath.indexOf("no_pic")==-1){picpaths[pics]=foods[p].picpath;pics++;}}
html2+='<ul class="picAndlistUl">';var i;var imgfloat="left";var flag=false;for(var m=0;m<length;m++){if(flag==false&&pics>0){if(imgfloat=="left"){html2+='<div style="width:750px;height:250px" ><div class="hasPicBox imgleft" ><div class="hasPic "><img src="'+picpaths[picpaths.length-pics]+'" width="310" height="190" border="0"/></div></div>';imgfloat="right";}else{html2+='<div style="width:750px;height:250px" ><div class="hasPicBox imgright" ><div class="hasPic "><img src="'+picpaths[picpaths.length-pics]+'" width="310" height="190" border="0"/></div></div>';imgfloat="left";}
pics--;i=3;flag=true;}
if(flag){html2+='<li class="liEven liHasPic " style="border:none" onmouseover="javascript:mouseOverAlcohol(this);" onmouseout="javascript:mouseoutAlcohol(this);">';if(--i==0){flag=false;}
html2+='<p class="left pTittle">'+foods[m].name+'</p>';if(foods[m].intr.length>0){html2+='<p class="introducation">'+foods[m].intr+'</p>';}
...
html2+='<div class="successaddmenu1">成功加入菜单</div></li>';if(i==0){html2+='</div><div style="clear:both,width:100%,height:6px;"></div>';}}else{html2+='<li class="liEven  clearfix" style="border:none" onmouseover="javascript:mouseOverAlcohol(this);" onmouseout="javascript:mouseoutAlcohol(this);">';html2+='<p class="left pTittle">'+foods[m].name+'</p>';if(foods[m].intr.length>0){html2+='<p class="nopicIntroducation">'+foods[m].intr+'</p>';}
html2+='<p class="left gray"> 原价<del>￥'+foods[m].price+'</del></p><p class="left "><span class="price">折扣价￥'+foods[m].curprice+'</span>./'+foods[m].unitdesc+'</p>';if(foods[m].issupplytype=='0'){html2+='<p class="right"><a onclick="javascript:addToMyCartnoleave4(\''+foods[m].foodid+'\', \''+foods[m].foodtype+'\', \''+foods[m].curprice+'\', \'0\', \''+foods[m].name+'\', \''+restaurantid+'\', this);"><img src="'+_context+'/images/orderfood/btnAddToDiet.gif" /></a></p>';}else{html2+='<p class="right"><a href="javascript:void(0);"><img src="'+_context+'/images/orderfood/btnAddToDiet2.gif" /></a></p>';}
html2+='<div class="successaddmenu1">成功加入菜单</div></li>';}}
html2+='</ul>';}else{for(var j=0;j<length;j++){html2+='<div  class="divli">'+'<img src="'+foods[j].picpath+'" width="93" height="95" border="0" onerror="this.src=\''+_context+'/images/no_pic.gif\'" onclick="javascript:intofooddetails2(\''+restaurantid+'\', \''+foods[j].foodid+'\');"/>'+'<div class="clearfix foodTittleAndPrice blueFont" style="cursor:pointer;" onclick="javascript:intofooddetails2(\''+restaurantid+'\', \''+foods[j].foodid+'\');">'+foods[j].name+'</div>';if(foods[j].price==''){html2+='<p><del>时价</del><b class="greenFont"> </b>'+'<a class="blueFont"> </a>'+'</p>'+'</div>';}else{html2+='<p><del>￥'+foods[j].price+'</del><b class="greenFont">￥'+foods[j].curprice+'/'+foods[j].unitdesc+'</b>';if(foods[j].issupplytype=='0'){html2+='<a class="blueFont" onclick="javascript:addToMyCartnoleave2(\''+foods[j].foodid+'\', \''+foods[j].foodtype+'\', \''+foods[j].curprice+'\', \'0\', \''+foods[j].name+'\', \''+restaurantid+'\', this);">加入菜单</a>';}else{html2+='<a class="blueFont" href="javascript:void(0);">暂停供应</a>';}
html2+='</p><div class="successaddmenu">成功加入菜单</div>'+'</div>';}}}}
...
$("#searchrest").click(function(){var restfiltertype=$("#restfiltertype").val();var searchword=$("#searchword").val();if(searchword==''){$("#searchword").focus();return;};$("#rest_search_suggest").hide();$("span[name='menutitle']").html('所有');$("span[name='menutitle']").unbind('click');$("span[name='menutitle']").bind('click',function(event){$("#allrestfood").click();event.stopPropagation();});$("span[name='menusectitle']").unbind('click');$("span[name='menusectitle']").html('>关键词\'<font color="black">'+searchword+'</font>\'').show();$("span[name='menusectitle']").bind('click',function(event){$("#searchrest").click();event.stopPropagation();});$("span[name='menusectitle']").next().remove();$("span[name='menusectitle']").css('cursor','pointer');$("#filtertypelist").find('li').removeClass('filtercurrent');var hashstr='';if(restfiltertype=='0'){hashstr='wordsearch_1_'+restaurantid+'_0_'+searchword;}else{hashstr='wordsearch_1_10_'+restaurantid+'_0_0_0_x_0_0_0_0_'+searchword;}
hashstr=hashstr.replace(/^.*#/,'');$.historyLoad(hashstr);});PageClick=function(pageclickednumber){var totalpages=$("#totalpage").val();var body=(window.opera)?(document.compatMode=="CSS1Compat"?$('html'):$('body')):$('html,body');$("#pager").pager({pagenumber:pageclickednumber,pagecount:totalpages,buttonClickCallback:PageClick});$("#pageno").val(pageclickednumber);var searchword=$("#searchword").val();if(searchword==''){searchword='0';}
...
var hashstr=filterobject+'_'+pageclickednumber+'_'+pageSize+'_'+restaurantid+'_'+newsorttype+'_'+foodtype+'_'+dishalcotype+'_'+pricerange+'_'+dishestype+'_'+cookingtype+'_'+tastetype+'_'+rawmaterialtype+'_'+searchword;hashstr=hashstr.replace(/^.*#/,'');$.historyLoad(hashstr);body.animate({scrollTop:$('#right-menu').offset().top-100},50);}
