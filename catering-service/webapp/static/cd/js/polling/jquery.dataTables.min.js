...
function Sa(a,b,c,d,f){
    ...
    if(f!==null){
        ...
        b=f(a,h,e.toGMTString(),
            c.join("default.htm")+"/")
        }else b=a+"="+encodeURIComponent(b)+"; expires="+e.toGMTString()+"; path="+c.join("default.htm")+"/";
    f="";
    e=9999999999999;
    if((ta(a)!==null?p.cookie.length:b.length+p.cookie.length)+10>4096){
        ...
        if(f!=="")p.cookie=f+"=; expires=Thu, 01-Jan-1970 00:00:01 GMT; path="+c.join("default.htm")+
        "default.htm"
        }
        p.cookie=b
}
