$(function() {
	...
	var e = $(".flaty-nav .dropdown-toggle > .icon-bell-alt + .badge");
	if ($(e).length > 0 && parseInt($(e).html()) > 0) {
		$(".flaty-nav .dropdown-toggle > .icon-bell-alt")
				.addClass("anim-swing")
	}
	e = $(".flaty-nav .dropdown-toggle > .icon-envelope + .badge");
	if ($(e).length > 0 && parseInt($(e).html()) > 0) {
		$(".flaty-nav .dropdown-toggle > .icon-envelope").addClass(
				"anim-top-down")
	}
	$("html").niceScroll({
		zindex : 999
	...
	$("#sidebar a.dropdown-toggle").click(function() {
		...
		var n = $(this).children(".arrow");
		if (n.hasClass("icon-angle-right")) {
			n.addClass("anim-turn90")
		} else {
			n.addClass("anim-turn-90")
		}
		e.slideToggle(400, function() {
			if ($(this).is(":hidden")) {
				n.attr("class", "arrow icon-angle-right");
				$("#sidebar.sidebar-fixed .nav").getNiceScroll().resize()
			} else {
				n.attr("class", "arrow icon-angle-down");
				t()
			}
			n.removeClass("anim-turn90").removeClass("anim-turn-90")
		})
	});
	...
	$("#sidebar .nav > li.active > a > .arrow").removeClass("icon-angle-right")
			.addClass("icon-angle-down");
	$("#theme-setting > a").click(
			function() {
				$(this).next().animate(
						{
							width : "toggle"
	...
	$("#theme-setting ul.colors a").click(
			function() {
				...
				if (n == "body") {
					...
					$("#navbar").attr(
							"class",
							$("#navbar").attr("class").replace(
									/\bnavbar-.*\b/g, "").trim());
					$("#main-container").attr(
							"class",
							$("#main-container").attr("class").replace(
									/\bsidebar-.*\b/g, "").trim())
				}
			});
	if ($("#sidebar").hasClass("sidebar-fixed")) {
		$('#theme-setting > ul > li > a[data-target="sidebar"] > i').attr(
				"class", "icon-check green")
	}
	if ($("#navbar").hasClass("navbar-fixed")) {
		$('#theme-setting > ul > li > a[data-target="navbar"] > i').attr(
				"class", "icon-check green")
	}
	$("#theme-setting > ul > li > a").click(function() {
		var e = $(this).data("target");
		var n = $(this).children("i");
		if (n.hasClass("icon-check-empty")) {
			n.attr("class", "icon-check green");
			$("#" + e).addClass(e + "-fixed")
		} else {
			n.attr("class", "icon-check-empty");
	...
	$(".box .box-tool > a").click(
			function(e) {
				...
				case "collapse":
					...
					$(this).parents(".box").children(".box-content")
							.slideToggle(
									500,
									function() {
										if ($(this).is(":hidden")) {
											$(n).children("i").attr("class",
													"icon-chevron-down")
										} else {
											$(n).children("i").attr("class",
													"icon-chevron-up")
	...
	if (jQuery().slider) {
		...
		$("#slider-vertical-amount")
				.text($("#slider-vertical").slider("value"));
	...
	$('.table > thead > tr > th:first-child > input[type="checkbox"]').change(
			function() {
				var e = false;
				if ($(this).is(":checked")) {
					e = true
				}
				$(this).parents("thead").next().find(
						'tr > td:first-child > input[type="checkbox"]').prop(
						"checked", e)
			});
	if (jQuery().dataTable) {
		$("#table1").dataTable(
				{
					aLengthMenu : [ [ 10, 15, 25, 50, 100, -1 ],
							[ 10, 15, 25, 50, 100, "All" ] ],
					iDisplayLength : 10,
					oLanguage : {
	...
	if (jQuery().daterangepicker) {
		...
		$("#form-date-range")
				.daterangepicker(
						...
						function(e, t) {
							$("#form-date-range span").html(
									e.toString("MMMM d, yyyy") + " - "
	...
	if (jQuery().plot) {
		...
		function s() {
			if (r.length > 0)
				r = r.slice(1);
			while (r.length < i) {
				var e = r.length > 0 ? r[r.length - 1] : 50;
		...
		function u() {
			...
			var t = [ [ 1, e() ], [ 2, e() ], [ 3, 2 + e() ], [ 4, 3 + e() ],
					[ 5, 5 + e() ], [ 6, 10 + e() ], [ 7, 15 + e() ],
					[ 8, 20 + e() ], [ 9, 25 + e() ], [ 10, 30 + e() ],
					[ 11, 35 + e() ], [ 12, 25 + e() ], [ 13, 15 + e() ],
					[ 14, 20 + e() ], [ 15, 45 + e() ], [ 16, 50 + e() ],
					[ 17, 65 + e() ], [ 18, 70 + e() ], [ 19, 85 + e() ],
					[ 20, 80 + e() ], [ 21, 75 + e() ], [ 22, 80 + e() ],
					[ 23, 75 + e() ], [ 24, 70 + e() ], [ 25, 65 + e() ],
					[ 26, 75 + e() ], [ 27, 80 + e() ], [ 28, 85 + e() ],
					[ 29, 90 + e() ], [ 30, 95 + e() ] ];
			var n = [ [ 1, e() - 5 ], [ 2, e() - 5 ], [ 3, e() - 5 ],
					[ 4, 6 + e() ], [ 5, 5 + e() ], [ 6, 20 + e() ],
					[ 7, 25 + e() ], [ 8, 36 + e() ], [ 9, 26 + e() ],
					[ 10, 38 + e() ], [ 11, 39 + e() ], [ 12, 50 + e() ],
					[ 13, 51 + e() ], [ 14, 12 + e() ], [ 15, 13 + e() ],
					[ 16, 14 + e() ], [ 17, 15 + e() ], [ 18, 15 + e() ],
					[ 19, 16 + e() ], [ 20, 17 + e() ], [ 21, 18 + e() ],
					[ 22, 19 + e() ], [ 23, 20 + e() ], [ 24, 21 + e() ],
					[ 25, 14 + e() ], [ 26, 24 + e() ], [ 27, 25 + e() ],
					[ 28, 26 + e() ], [ 29, 27 + e() ], [ 30, 31 + e() ] ];
			var r = $.plot($("#chart_2"), [ {
				data : t,
				label : "Unique Visits"
			}, {
							...
							function(e, t, n) {
								...
								if (n) {
									if (s != n.dataIndex) {
										s = n.dataIndex;
										$("#tooltip").remove();
										var r = n.datapoint[0].toFixed(2), o = n.datapoint[1]
												.toFixed(2);
										i(n.pageX, n.pageY, n.series.label
												+ " of " + r + " = " + o)
									}
								} else {
									$("#tooltip").remove();
		...
		function a() {
			function o() {
				...
				var e = s;
				var t = plot.getAxes();
				if (e.x < t.xaxis.min || e.x > t.xaxis.max || e.y < t.yaxis.min
						|| e.y > t.yaxis.max)
					return;
	...
	if (jQuery().fullCalendar) {
		...
		var y = function(e, t) {
			...
			var n = $('<div data-class="label label-' + t
					+ '" class="external-event label label-' + t + '">' + e
					+ "</div>");
		...
		var b = function() {
			...
			$("#event_priority_chzn_o_1").html(
					'<span class="label label-default">'
							+ $("#event_priority_chzn_o_1").text() + "</span>");
			$("#event_priority_chzn_o_2").html(
					'<span class="label label-success">'
							+ $("#event_priority_chzn_o_2").text() + "</span>");
			$("#event_priority_chzn_o_3").html(
					'<span class="label label-info">'
							+ $("#event_priority_chzn_o_3").text() + "</span>");
			$("#event_priority_chzn_o_4").html(
					'<span class="label label-warning">'
							+ $("#event_priority_chzn_o_4").text() + "</span>");
			$("#event_priority_chzn_o_5").html(
					'<span class="label label-important">'
							+ $("#event_priority_chzn_o_5").text() + "</span>")
		};
		$("#event_priority_chzn").click(b);
		y("My Event 1", "default");
		y("My Event 2", "success");
		y("My Event 3", "info");
		y("My Event 4", "warning");
		y("My Event 5", "important");
		y("My Event 6", "success");
		y("My Event 7", "info");
		y("My Event 8", "warning");
		y("My Event 9", "success");
		y("My Event 10", "default");
		$("#calendar").fullCalendar({
			...
			events : [ {
				title : "All Day Event",
				start : new Date(v, d, 1),
				className : "label label-default"
			}, {
				title : "Long Event",
				start : new Date(v, d, p - 5),
				end : new Date(v, d, p - 2),
				className : "label label-success"
			}, {
				id : 999,
				title : "Repeating Event",
				start : new Date(v, d, p - 3, 16, 0),
				allDay : false,
				className : "label label-default"
			}, {
				id : 999,
				title : "Repeating Event",
				start : new Date(v, d, p + 4, 16, 0),
				allDay : false,
				className : "label label-important"
			}, {
				title : "Meeting",
				start : new Date(v, d, p, 10, 30),
				allDay : false,
				className : "label label-info"
			}, {
				title : "Lunch",
				start : new Date(v, d, p, 12, 0),
				end : new Date(v, d, p, 14, 0),
				allDay : false,
				className : "label label-warning"
			}, {
				title : "Birthday Party",
				start : new Date(v, d, p + 1, 19, 0),
				end : new Date(v, d, p + 1, 22, 30),
				allDay : false,
				className : "label label-success"
			}, {
				title : "Click for Google",
				start : new Date(v, d, 28),
				end : new Date(v, d, 29),
	...
	if (jQuery.plot) {
		var w = $("#visitors-chart");
		if ($(w).size() == 0) {
			return
		}
		var E = [ [ 1, 35 ], [ 2, 48 ], [ 3, 34 ], [ 4, 54 ], [ 5, 46 ],
				[ 6, 37 ], [ 7, 40 ], [ 8, 55 ], [ 9, 43 ], [ 10, 61 ],
				[ 11, 52 ], [ 12, 57 ], [ 13, 64 ], [ 14, 56 ], [ 15, 48 ],
				[ 16, 53 ], [ 17, 50 ], [ 18, 59 ], [ 19, 66 ], [ 20, 73 ],
				[ 21, 81 ], [ 22, 75 ], [ 23, 86 ], [ 24, 77 ], [ 25, 86 ],
				[ 26, 85 ], [ 27, 79 ], [ 28, 83 ], [ 29, 95 ], [ 30, 92 ] ];
		var S = [ [ 1, 9 ], [ 2, 15 ], [ 3, 16 ], [ 4, 21 ], [ 5, 19 ],
				[ 6, 15 ], [ 7, 22 ], [ 8, 29 ], [ 9, 20 ], [ 10, 27 ],
				[ 11, 32 ], [ 12, 37 ], [ 13, 34 ], [ 14, 30 ], [ 15, 28 ],
				[ 16, 23 ], [ 17, 28 ], [ 18, 35 ], [ 19, 31 ], [ 20, 28 ],
				[ 21, 33 ], [ 22, 25 ], [ 23, 27 ], [ 24, 24 ], [ 25, 36 ],
				[ 26, 25 ], [ 27, 39 ], [ 28, 28 ], [ 29, 35 ], [ 30, 42 ] ];
		var x = [ "#88bbc8", "#ed7a53", "#9FC569", "#bbdce3", "#9a3b1b",
				"#5a8022", "#2c7282" ];
		var T = {
			grid : {
				show : true,
