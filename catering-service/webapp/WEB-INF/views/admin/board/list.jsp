...
<div class="row-fluid">
    <div class="span12">
        <div class="box">
            <div class="box-title">
                <h3><i class="icon-table"></i> Board Panel</h3>
            ...
            <div class="box-content">
                <div class="btn-toolbar pull-right">
                    <div class="btn-group">
                        <a class="btn btn-circle show-tooltip" title="" href="<c:url value="/admin/board/add/"/>${cid}"
                           data-original-title="Add new record"><i class="icon-plus"></i></a>
                ...
                <table class="table table-advance">
                    ...
                    <tr>
                        ...
                        <th>summary</th>
                        <th>status</th>
                        <th class="text-center">galleryful</th>
                    ...
                    <c:forEach items="${pages.content}" var="d" varStatus="s">
                        <tr class="table-flag-blue" id="tr_${d.id}">
                            ...
                            <td>${d.summary}</td>
                            <td>${d.boardStatus}</td>
                            <td class="text-center">${d.galleryful}</td>
                            <td>
                                <div class="btn-group">
                                    <a class="btn btn-lime  show-tooltip" title=""
                                       href="<c:url value="/admin/board/get/"/>${d.id}?op=view"
                                       data-original-title="View"><i class="icon-zoom-in"></i></a>
                                    <a class="btn btn-primary show-tooltip" title=""
                                       href="<c:url value="/admin/board/get/"/>${d.id}" data-original-title="Edit">
                                        <i class="icon-edit"></i></a>
                                    <a class="btn btn-danger show-tooltip" msg="Delete OK!" title=""
                                       href="javascript:UTL.del('<c:url value="/admin/board/del" />' ,'${d.id}')"
