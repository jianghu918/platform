        ...
        <div class="box">
            ...
            <div class="box-content">
                ...
                <form id="objForm" class="form-horizontal" action="<c:url value="/admin/board/add" />" method="post">
                    ...
                    <div class="control-group info">
                        <label class="control-label" for="b_sn">board serial number :</label>

                        <div class="controls">
                            <div class="span12">
                                <input id="b_sn" type="text" name="sn" value="${obj.sn}" class="span1" data-rule-digits="true" data-rule-range="1,10"  />
                                -
                                <input id="b_sn2" type="text" name="en" value="${obj.nn}" class="span1" data-rule-digits="true" data-rule-range="1,10"  />
                            </div>
                            序列号比如填1-10,将会生成以name prefix为首的10个对象。
                            如name prefix为 NJ00, 就生成NJ001,NJ002... NJ010十张桌子。
                        </div>
                    </div>
                        ...
                        <div class="controls">
                            <div class="span12">
                                <c:forEach var="s" items="${status}" >
                                    ...
                                    <input id="status_${s.value}"  type="radio" name="boardStatus" value="${s.value}" <c:if test="${s.value eq 0}">checked</c:if>  />
                                </c:forEach>
                            </div>
                        </div>
                    </div>--%>
