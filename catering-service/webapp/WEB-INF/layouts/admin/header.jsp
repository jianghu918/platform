...
<li class="hidden-phone">
    <a href="<c:url value="/"/>" target="_blank">
        <i class="icon-fire"></i>
        <span class="badge badge-info">首页</span>
    </a>
</li>
...
<li class="hidden-phone">
    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
        <i class="icon-bell-alt anim-swing"></i>
    ...
    <ul class="dropdown-navbar dropdown-menu">
        ...
        <li class="notify">
            <a href="#">
                <img src="${ctx}/static/img/demo/avatar/avatar2.jpg" alt="Alex">
...
<li class="hidden-phone">
    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
        <i class="icon-envelope anim-top-down"></i>
    ...
    <ul class="dropdown-navbar dropdown-menu">
        ...
        <li class="msg">
            <a href="#">
                <img src="${ctx}/static/img/demo/avatar/avatar3.jpg" alt="Sarah's Avatar">
                <div>
...
<span>a moment ago</span>
        ...
        <li class="msg">
            <a href="#">
                <img src="${ctx}/static/img/demo/avatar/avatar4.jpg" alt="Emma's Avatar">
                <div>
...
<span>2 Days ago</span>
        ...
        <li class="msg">
            <a href="#">
                <img src="${ctx}/static/img/demo/avatar/avatar5.jpg" alt="John's Avatar">
                <div>
...
<li class="user-profile">
    <a data-toggle="dropdown" href="#" class="user-menu dropdown-toggle">
        <img class="nav-user-photo" src="${ctx}/static/img/demo/avatar/avatar1.jpg" alt="Penny's Photo">
